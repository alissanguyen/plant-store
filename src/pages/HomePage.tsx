...
const HomePage: React.FC<Props> = ({ }) => {
    return (
        <div className="flex flex-col custom:grid custom:grid-cols-2 px-[10%] gap-10 xl:gap-20 mt-12 custom:mt-20 mb-10 h-full">
            <HomePageTextContent />
            <HomePageThumbs />
        </div>
    )
...
const HomePageTextContent = () => {
    return (
        <div className="flex flex-col">
            ...
            <span className='text-base lg:text-xl italic leading-relaxed'>We have shipped more than 500+ plants across 47 states in America. We take pride in our services and commitment to the plant community.</span>
        </div>
    )
}
...
const HomePageThumbs: React.FC = () => {
    return (
        <div className="Header__Thumbs flex flex-col gap-4 ">
